...
//                    yield PgRow { phantom: PhantomData, data, columns: Arc::clone(&columns) };
//                }
//            }
//
...
impl<'con> crate::Executor<'con> for &'con mut super::PgConnection {
    type Database = super::Postgres;

    fn execute<'q, E>(self, query: E) -> PgCursor<'con>
    where
        E: Execute<'q, Self::Database>,
    {
        ...
        PgCursor::from_connection(statement, self)
    }

    fn execute_by_ref<'q, 'e, E>(&'e mut self, query: E) -> PgCursor<'e>
    where
        E: Execute<'q, Self::Database>,
    {
        todo!()
